...
var Monitoring = new keystone.List('SystemEvaluation');
...
Monitoring.schema.pre('save', function(next) {
    this.wasNew = this.isNew;
    next();
})

Monitoring.schema.post('save', function() {
 ...
 * Registration
 */
Monitoring.defaultSort = '-createdAt';
Monitoring.defaultColumns = 'name, email, createdAt';
Monitoring.register();
